...
rdfs:subClassOf: [{"@id":"schema:PaymentCard"},{"@id":"schema:LoanOrCredit"}]
schema:contributor: [{"@id":"https://schema.org/docs/collab/GoodRelationsClass"},{"@id":"https://schema.org/docs/collab/FIBO"}]
---
