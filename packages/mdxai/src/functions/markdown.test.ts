...
describe('markdown function', () => {
  ...
  it('should parse markdown into proper MDAST structure', async () => {
    ...
    const validNodeTypes = ['heading', 'paragraph', 'code', 'list', 'blockquote', 'text', 'listItem', 'strong', 'emphasis', 'inlineCode', 'link', 'thematicBreak']
    const hasValidNodes = nodeTypes.every((type: string) => validNodeTypes.includes(type))
    expect(hasValidNodes).toBe(true)
    
    // Check for code block (more likely to be present when asking for code example)
