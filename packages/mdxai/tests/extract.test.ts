...
import { extract } from '../src/functions/extract.js'
...
describe('extract function', () => {
  ...
  describe('error handling', () => {
    it('should throw error when not used as template literal', () => {
      expect(() => extract('not a template literal' as any)).toThrow('extract function must be used as a template literal tag')
    })
