...
// Common enums/types
export type UseCase = 'InvestorPitch' | 'ProductDemo' | 'TechTalk' | 'Onboarding' | 'Keynote'

export type SlideType = 'Title' | 'Section' | 'Content' | 'Code' | 'Image' | 'Chart'

export type LayoutType = 'SingleColumn' | 'TwoColumn' | 'Split' | 'FullBleed' | 'Centered'

export type Theme = 'Light' | 'Dark' | string

export type NarrativeRole = 'Intro' | 'Problem' | 'Solution' | 'Approach' | 'Results' | 'Conclusion' | 'CallToAction'
