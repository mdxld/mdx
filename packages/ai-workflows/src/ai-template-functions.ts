/**
 * AI template functions for AI workflows
 * Extracted from MDXE CLI execution context
 */
...
export function clearAIRequests() {
  aiRequests = []
...
export const aiTemplateFunction = async (strings: TemplateStringsArray, ...values: any[]) => {
...
export const listTemplateFunction = async function* (strings: TemplateStringsArray, ...values: any[]) {
  const prompt = String.raw(strings, ...values)
  await createAiFolderStructure()
...
export const researchTemplateFunction = async (strings: TemplateStringsArray, ...values: any[]) => {
  const prompt = String.raw(strings, ...values)
  await createAiFolderStructure()
...
export const extractTemplateFunction = async (strings: TemplateStringsArray, ...values: any[]) => {
  const prompt = String.raw(strings, ...values)
  await createAiFolderStructure()
