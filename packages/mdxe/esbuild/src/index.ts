...
import { MdxeBuildOptions } from './types'
 ...
 */
function generateIndexSource(contentDir: string, entries: string[]): string {
  let indexSource = ''
...
async function buildMdxContent(options: MdxeBuildOptions = {}): Promise<void> {
  ...
  const indexSource = generateIndexSource(contentDir, entries)
...
export { toTitleCase, generateIndexSource, findMdxFiles, buildMdxContent, mdxePlugin, MdxeBuildOptions }

// Export types
export type { MdxContentItem, MdxContentMap } from './types'
