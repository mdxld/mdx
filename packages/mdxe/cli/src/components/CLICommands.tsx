...
export const CLICommands: React.FC<CLICommandsProps> = ({
  cwd,
  onSelectCommand,
  onExit
}) => {
  ...
  return (
    <Box flexDirection="column" padding={1}>
      <Box marginBottom={1}>
        <Text bold color="green">MDXE - Markdown/MDX-First Application Framework</Text>
      </Box>
      
      <Box marginBottom={1}>
        <Text>Current directory: <Text color="blue">{cwd}</Text></Text>
      </Box>
      ...
      <Box flexDirection="column" marginY={1}>
        <Text><Text color="yellow">t</Text> - <Text bold>test</Text>: Run tests embedded in Markdown/MDX files</Text>
        <Text><Text color="yellow">d</Text> - <Text bold>dev</Text>: Start a development server</Text>
        <Text><Text color="yellow">b</Text> - <Text bold>build</Text>: Build the project for production</Text>
        <Text><Text color="yellow">s</Text> - <Text bold>start</Text>: Start the production server</Text>
        <Text><Text color="yellow">e</Text> - <Text bold>exec</Text>: Execute code blocks in Markdown/MDX files</Text>
        <Text><Text color="yellow">h</Text> - <Text bold>help</Text>: Show help information</Text>
      </Box>
